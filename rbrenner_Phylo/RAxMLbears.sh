...
raxmlHPC-PTHREADS-AVX -T 8 -f a -m GTRGAMMA -p 618 -N 2 -x 309 -s AllBears.aln -n AllBearsTree -w /project/inbre-train/inbre020/molb4485/rbrenner_Phylo/AllBearsTree -o GiantPanda
